...
public class EVA_FlightsPage extends TestBase {
	...
	public void searchFromFlight(String keyword, String location) throws InterruptedException {
		...
		List<WebElement> list = driver.findElements(
				By.xpath("//small[@class='d-inline cityairport-name px-2'] //span[@class='d-block cityname']"));
	...
	public void calendar(String month, String day) {
		...
		int count = driver
				.findElements(By
						.cssSelector("[class='ui-state-default datepicker-content-d41d8cd98f00b204e9800998ecf8427e']"))
				.size();

		for (int i = 0; i < count; i++) {
			String text = driver
					.findElements(By.cssSelector(
							"[class='ui-state-default datepicker-content-d41d8cd98f00b204e9800998ecf8427e']"))
					.get(i).getText();
